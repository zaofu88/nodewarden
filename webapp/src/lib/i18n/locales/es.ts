...
const es: Record<string, string> = {
  ...
  "txt_backup_recommend_backblaze_summary": "Almacenamiento de objetos compatible con S3 con 10 GB gratis. Use el endpoint S3 de B2, el nombre del bucket, la región, keyID y applicationKey.",
  ...
  "txt_backup_recommend_backblaze_step_3": "Después de crearlo, use el Endpoint mostrado como endpoint S3, el nombre del bucket como bucket y la parte central del endpoint, como us-west-004, como región.",
  ...
  "txt_backup_recommend_cloudflare_r2_summary": "Almacenamiento de objetos compatible con S3 con 10 GB-month gratis al mes. Mantenga la región en auto.",
  ...
  "txt_backup_recommend_cloudflare_r2_step_4": "Use https://<ID de cuenta>.r2.cloudflarestorage.com como URL del endpoint S3, rellene el nombre del bucket tal como aparece y mantenga la región en auto.",
  "txt_backup_recommend_cloudflare_r2_step_5": "Configure el prefijo de ruta si lo necesita, por ejemplo nodewarden/backups, o déjelo vacío si no quiere un prefijo de carpeta.",
