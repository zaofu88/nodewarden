...
const zhTW: Record<string, string> = {
  ...
  "txt_backup_recommend_backblaze_summary": "兼容 S3 的對象儲存，免費容量 10 GB。需要填寫 B2 的 S3 端點、桶名、區域、keyID 和 applicationKey。",
  ...
  "txt_backup_recommend_backblaze_step_3": "創建後顯示的 Endpoint 就是 S3 端點；桶名字就是儲存桶；區域填寫 Endpoint 中間的區域值，例如 us-west-004。",
  ...
  "txt_backup_recommend_cloudflare_r2_summary": "兼容 S3 的對象儲存，免費層每月 10 GB-month，區域保持 auto 不改。",
  ...
  "txt_backup_recommend_cloudflare_r2_step_4": "S3 端點 URL 填 https://<賬戶 ID>.r2.cloudflarestorage.com；儲存桶名稱如實填寫；區域保持 auto 不改。",
  "txt_backup_recommend_cloudflare_r2_step_5": "路徑前綴按需要填寫，例如 nodewarden/backups；不想分目錄可以留空。",
