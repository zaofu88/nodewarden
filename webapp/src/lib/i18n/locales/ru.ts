...
const ru: Record<string, string> = {
  ...
  "txt_backup_recommend_backblaze_summary": "S3-совместимое объектное хранилище с бесплатными 10 ГБ. Используйте S3 endpoint B2, имя bucket, регион, keyID и applicationKey.",
  ...
  "txt_backup_recommend_backblaze_step_3": "После создания используйте показанный Endpoint как S3 endpoint, имя bucket как bucket, а среднюю часть endpoint, например us-west-004, как регион.",
  ...
  "txt_backup_recommend_cloudflare_r2_summary": "S3-совместимое объектное хранилище с бесплатным уровнем 10 GB-month в месяц. Оставьте регион auto.",
  ...
  "txt_backup_recommend_cloudflare_r2_step_4": "Укажите https://<ID аккаунта>.r2.cloudflarestorage.com как URL S3 endpoint, заполните имя bucket как есть и оставьте регион auto.",
  "txt_backup_recommend_cloudflare_r2_step_5": "Укажите префикс пути при необходимости, например nodewarden/backups, или оставьте пустым, если префикс папки не нужен.",
